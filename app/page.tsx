...
export default function Dashboard() {
  ...
  return (
    <div className="p-5 font-mono">
      {notification && (
        <div className="fixed top-5 right-5 px-5 py-2.5 bg-green-500 text-white rounded z-50">
          {notification}
        </div>
      )}
      ...
      <div className="my-5 p-4 bg-gray-100 rounded">
        ...
        <button 
          ...
          className="mt-3 px-5 py-2.5 bg-blue-500 text-white rounded hover:bg-blue-600 cursor-pointer"
        >
          Manual Refresh
        </button>
      </div>
